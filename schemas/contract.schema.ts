...
export const SearchContractSchema = z.object({
    ...
    thePostagePeriodFrom: z.optional(z.string()),
    thePostagePeriodIsUpTo: z.optional(z.string()),
    point: z.optional(z.string()),
    subItem: z.optional(z.string()),
    theAmountOfTheContractFrom: z.optional(z.string()),
    theAmountOfTheContractIsUpTo: z.optional(z.string()),
